...
class FollowRequestComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<FollowRequestListBloc>(
      ...
      child: SelectFollowRequestWidget(app: app,
          height: height,
...
class SelectFollowRequestWidget extends StatefulWidget {
  ...
  @override
  _SelectFollowRequestWidgetState createState() {
    return _SelectFollowRequestWidgetState();
  }
}

class _SelectFollowRequestWidgetState extends State<SelectFollowRequestWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<FollowRequestListBloc>(context).add(
            FollowRequestChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
