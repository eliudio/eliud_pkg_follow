...
typedef FollowingDashboardWidgetProvider(FollowingDashboardModel? value);

class FollowingDashboardListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  FollowingDashboardWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  FollowingDashboardListWidgetState? state;
  bool? isEmbedded;

  FollowingDashboardListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);

  @override
  FollowingDashboardListWidgetState createState() {
    state ??= FollowingDashboardListWidgetState();
    return state!;
  }
...
class FollowingDashboardListWidgetState extends State<FollowingDashboardListWidget> {
  @override
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              value: BlocProvider.of<FollowingDashboardListBloc>(context),
              child: FollowingDashboardForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return FollowingDashboardListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return FollowingDashboardForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
