...
class FollowingDashboardListWidget extends StatefulWidget with HasFab {
  ...
  FollowingDashboardListWidget({ Key key, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
...
class FollowingDashboardListWidgetState extends State<FollowingDashboardListWidget> {
  ...
  Widget fab(BuildContext aContext, AccessState accessState) {
    if (accessState is AppLoaded) {
      return !accessState.memberIsOwner() 
        ...
        heroTag: "FollowingDashboardFloatBtnTag",
  ...
  Widget getForm(value, action) {
    if (widget.form == null) {
      return FollowingDashboardForm(value: value, formAction: action);
    } else {
      return null;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      child: ListTile(
        onTap: onTap,
        title: Hero(
          tag: '${value.documentID}__FollowingDashboardheroTag',
          child: Container(
