...
typedef FollowRequestChanged(String? value, int? privilegeLevel,);
...
class FollowRequestDropdownButtonWidget extends StatefulWidget {
  ...
  FollowRequestDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return FollowRequestDropdownButtonWidgetState();
  }
}

class FollowRequestDropdownButtonWidgetState extends State<FollowRequestDropdownButtonWidget> {
  FollowRequestListBloc? bloc;

  FollowRequestDropdownButtonWidgetState();
...
return widgets;
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'followRequests', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<FollowRequestListBloc>(context).add(FollowRequestChangeQuery(
