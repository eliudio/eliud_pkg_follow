...
class InviteDashboardComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<InviteDashboardListBloc>(
      ...
      child: SelectInviteDashboardWidget(app: app,
          height: height,
...
class SelectInviteDashboardWidget extends StatefulWidget {
  ...
  @override
  _SelectInviteDashboardWidgetState createState() {
    return _SelectInviteDashboardWidgetState();
  }
}

class _SelectInviteDashboardWidgetState extends State<SelectInviteDashboardWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<InviteDashboardListBloc>(context).add(
            InviteDashboardChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
