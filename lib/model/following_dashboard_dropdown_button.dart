...
typedef FollowingDashboardChanged(String? value, int? privilegeLevel,);
...
class FollowingDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  FollowingDashboardDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return FollowingDashboardDropdownButtonWidgetState();
  }
}

class FollowingDashboardDropdownButtonWidgetState extends State<FollowingDashboardDropdownButtonWidget> {
  FollowingDashboardListBloc? bloc;

  FollowingDashboardDropdownButtonWidgetState();
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a followingDashboard'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'followingDashboards', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<FollowingDashboardListBloc>(context).add(FollowingDashboardChangeQuery(
