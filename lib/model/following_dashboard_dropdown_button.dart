...
typedef FollowingDashboardChanged(String? value);
...
class FollowingDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  FollowingDashboardDropdownButtonWidget({ this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
List<Widget> widgets(FollowingDashboardModel pm) {
var widgets = <Widget>[];
      ...
      if (state is FollowingDashboardListLoading) {
        ...
        DropdownButton button = 
                    DropdownButton<String>(
                      ...
                      items: items,
                      value: valueChosen,
                      hint: Text('Select a followingDashboard'),
