...
typedef FollowRequestsDashboardChanged(String? value);
...
class FollowRequestsDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  FollowRequestsDashboardDropdownButtonWidget({ this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
List<Widget> widgets(FollowRequestsDashboardModel pm) {
var widgets = <Widget>[];
      ...
      if (state is FollowRequestsDashboardListLoading) {
        ...
        DropdownButton button = 
                    DropdownButton<String>(
                      ...
                      items: items,
                      value: valueChosen,
                      hint: Text('Select a followRequestsDashboard'),
