...
typedef FollowRequestsDashboardChanged(String? value, int? privilegeLevel,);
...
class FollowRequestsDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  FollowRequestsDashboardDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return FollowRequestsDashboardDropdownButtonWidgetState();
  }
}

class FollowRequestsDashboardDropdownButtonWidgetState extends State<FollowRequestsDashboardDropdownButtonWidget> {
  FollowRequestsDashboardListBloc? bloc;

  FollowRequestsDashboardDropdownButtonWidgetState();
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: DropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a followRequestsDashboard'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'followRequestsDashboards', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<FollowRequestsDashboardListBloc>(context).add(FollowRequestsDashboardChangeQuery(
