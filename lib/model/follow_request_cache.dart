...
class FollowRequestCache implements FollowRequestRepository {
  ...
  Future<FollowRequestModel> get(String id, {Function(Exception) onError}) {
    FollowRequestModel value = fullCache[id];
  ...
  @override
  StreamSubscription<List<FollowRequestModel>> listen(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<List<FollowRequestModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<FollowRequestModel> listenTo(String documentId, changed) {
