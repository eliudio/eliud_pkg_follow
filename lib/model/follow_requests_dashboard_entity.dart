...
class FollowRequestsDashboardEntity implements EntityBase {
  ...
  static FollowRequestsDashboardEntity? fromMap(Object? o, {Map<String, String>? newDocumentIds}) {
  ...
  static FollowRequestsDashboardEntity? fromJsonString(String json, {Map<String, String>? newDocumentIds}) {
