...
class FollowRequestsDashboardCache implements FollowRequestsDashboardRepository {
  ...
  @override
  StreamSubscription<List<FollowRequestsDashboardModel>> listen(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<List<FollowRequestsDashboardModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
