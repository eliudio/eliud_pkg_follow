...
typedef InviteDashboardChanged(String? value);
...
class InviteDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  InviteDashboardDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);
      ...
      if (state is InviteDashboardListLoading) {
        ...
        DropdownButton button = 
                    DropdownButton<String>(
                      ...
                      items: items,
                      value: valueChosen,
                      hint: Text('Select a inviteDashboard'),
