...
typedef InviteDashboardChanged(String? value, int? privilegeLevel,);
...
class InviteDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  InviteDashboardDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return InviteDashboardDropdownButtonWidgetState();
  }
}

class InviteDashboardDropdownButtonWidgetState extends State<InviteDashboardDropdownButtonWidget> {
  InviteDashboardListBloc? bloc;

  InviteDashboardDropdownButtonWidgetState();
...
List<Widget> widgets(InviteDashboardModel value) {
var app = widget.app;
var widgets = <Widget>[];
...
return widgets;
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'inviteDashboards', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<InviteDashboardListBloc>(context).add(InviteDashboardChangeQuery(
