...
class FollowRequestJsFirestore implements FollowRequestRepository {
  Future<FollowRequestModel> add(FollowRequestModel value) {
    return followRequestCollection.doc(value.documentID)
  ...
  Future<FollowRequestModel> get(String id, { Function(Exception) onError }) {
    return followRequestCollection.doc(id).get().then((data) {
      if (data.data() != null) {
  ...
  @override
  StreamSubscription<List<FollowRequestModel>> listen(FollowRequestModelTrigger trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    var stream;
  ...
  StreamSubscription<List<FollowRequestModel>> listenWithDetails(FollowRequestModelTrigger trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    var stream;
    // If we use followRequestCollection here, then the second subscription fails
    stream = getQuery(getCollection(), currentMember: currentMember, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).onSnapshot
        .asyncMap((data) async {
  ...
  Stream<List<FollowRequestModel>> values({String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    ...
    Stream<List<FollowRequestModel>> _values = getQuery(followRequestCollection, currentMember: currentMember, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)
      .onSnapshot
      .map((data) { 
  ...
  Future<List<FollowRequestModel>> valuesList({String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) async {
    DocumentSnapshot lastDoc;
    List<FollowRequestModel> _values = await getQuery(followRequestCollection, currentMember: currentMember, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).get().then((value) {
      var list = value.docs;
      return list.map((doc) { 
        lastDoc = doc;
        return _populateDoc(doc);
  ...
  Future<void> deleteAll() {
    return followRequestCollection.get().then((snapshot) => snapshot.docs
        .forEach((element) => followRequestCollection.doc(element.id).delete()));
  }
