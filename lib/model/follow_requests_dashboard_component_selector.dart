...
class FollowRequestsDashboardComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<FollowRequestsDashboardListBloc>(
      ...
      child: SelectFollowRequestsDashboardWidget(app: app,
          height: height,
...
class SelectFollowRequestsDashboardWidget extends StatefulWidget {
  final AppModel app;
  final double height;
  ...
  const SelectFollowRequestsDashboardWidget(
      {Key? key,
      required this.app,
  ...
  @override
  _SelectFollowRequestsDashboardWidgetState createState() {
    return _SelectFollowRequestsDashboardWidgetState();
  }
}

class _SelectFollowRequestsDashboardWidgetState extends State<SelectFollowRequestsDashboardWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<FollowRequestsDashboardListBloc>(context).add(
            FollowRequestsDashboardChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }

  Widget theList(BuildContext context, List<FollowRequestsDashboardModel?> values) {
    var app = widget.app; 
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<FollowRequestsDashboardListBloc, FollowRequestsDashboardListState>(
      ...
      if ((state is FollowRequestsDashboardListLoaded) && (state.values != null)) {
