...
class FollowRequestsDashboardForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (formAction == FormAction.ShowData) {
      ...
      return Scaffold(
        appBar: StyleRegistry.registry().styleWithContext(context).adminFormStyle().constructAppBar(context, formAction == FormAction.UpdateAction ? 'Update FollowRequestsDashboard' : 'Add FollowRequestsDashboard'),
    ...
    return BlocBuilder<FollowRequestsDashboardFormBloc, FollowRequestsDashboardFormState>(builder: (context, state) {
      ...
      if (state is FollowRequestsDashboardFormInitialized) {
        ...
        children.add(
                  ...
                  StyleRegistry.registry().styleWithContext(context).adminFormStyle().textFormField(context, 'Document ID', Icons.vpn_key, (formAction == FormAction.UpdateAction), _documentIDController, FieldType.String, validator: (_) => state is DocumentIDFollowRequestsDashboardFormError ? state.message : null, hintText: 'null')
          );
        ...
        children.add(
                  ...
                  StyleRegistry.registry().styleWithContext(context).adminFormStyle().textFormField(context, 'Description', Icons.text_format, _readOnly(accessState, state), _descriptionController, FieldType.String, validator: (_) => state is DescriptionFollowRequestsDashboardFormError ? state.message : null, hintText: 'null')
          );
