...
class FollowingDashboardCache implements FollowingDashboardRepository {
  ...
  Future<FollowingDashboardModel> get(String id, {Function(Exception) onError}) {
    FollowingDashboardModel value = fullCache[id];
  ...
  @override
  StreamSubscription<List<FollowingDashboardModel>> listen(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<List<FollowingDashboardModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<FollowingDashboardModel> listenTo(String documentId, changed) {
